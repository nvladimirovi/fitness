        ...
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            imports: [
                _angular_router__WEBPACK_IMPORTED_MODULE_0__["RouterModule"].forRoot(appRoutes, {
                    enableTracing: false,
                    preloadingStrategy: _selective_preloading_strategy_service__WEBPACK_IMPORTED_MODULE_3__["SelectivePreloadingStrategyService"],
                })
            ],
            exports: [
...
module.exports = "<div class=\"main-container\">\r\n    <header class=\"header header-6\">\r\n      <div class=\"branding\">\r\n        <a routerLink=\"/home\" class=\"nav-link nav-icon\">\r\n          <clr-icon shape=\"home\"></clr-icon>\r\n          <span class=\"title\">MyFit</span>\r\n        </a>\r\n      </div>\r\n      <div class=\"header-nav\">\r\n        <a routerLink=\"/profile\"class=\"nav-link nav-icon\">\r\n          <clr-icon shape=\"user\"></clr-icon>\r\n        </a>\r\n      \r\n        <a routerLink=\"/admin\" class=\"nav-link nav-icon\">\r\n          <clr-icon shape=\"administrator\"></clr-icon>\r\n        </a>\r\n      </div>\r\n    </header>\r\n    <div class=\"content-container\">\r\n        <div class=\"content-area\">\r\n          <div [@routeAnimation]=\"getAnimationData(routerOutlet)\">\r\n            <router-outlet></router-outlet>\r\n          </div>\r\n        </div>\r\n    </div>\r\n</div>\r\n"
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            imports: [
                ...
                _angular_common_http__WEBPACK_IMPORTED_MODULE_11__["HttpClientXsrfModule"].withOptions({
...
/***/ "./src/app/core/rest-manager/rest.manager.ts":
/*!***************************************************!*\
  !*** ./src/app/core/rest-manager/rest.manager.ts ***!
  \***************************************************/
/*! exports provided: RestManager */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RestManager", function() { return RestManager; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
var RestManager = /** @class */ (function () {
    function RestManager(http) {
        this.http = http;
    }
    RestManager.prototype.get = function (url, options) {
        return this.http.get(url, options);
    };
    RestManager.prototype.post = function (url, body, options) {
        return this.http.post(url, body, options);
    };
    RestManager.prototype.put = function (url, body, options) {
        return this.http.put(url, body, options);
    };
    RestManager.prototype.delete = function (url, options) {
        return this.http.delete(url, options);
    };
    RestManager = __decorate([
...
/* harmony import */ var _register_register_module__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../register/register.module */ "./src/app/register/register.module.ts");
/* harmony import */ var _core_rest_manager_rest_manager__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../core/rest-manager/rest.manager */ "./src/app/core/rest-manager/rest.manager.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    HomeModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            imports: [
                ...
                _register_register_module__WEBPACK_IMPORTED_MODULE_4__["RegisterModule"],
            ],
            declarations: [_home_component__WEBPACK_IMPORTED_MODULE_2__["HomeComponent"]],
            providers: [
                _core_rest_manager_rest_manager__WEBPACK_IMPORTED_MODULE_5__["RestManager"]
            ]
        })
    ], HomeModule);
    return HomeModule;
...
module.exports = "<h3>Login</h3>\r\n\r\n<form clrForm [formGroup]=\"loginForm\">\r\n  <clr-input-container>\r\n    <label>Username</label>\r\n    <input clrInput type=\"text\" [formControlName]=\"UIFields.username\" />\r\n    <clr-control-helper>Enter your username</clr-control-helper>\r\n    <clr-control-error>\r\n      {{ loginForm.get(UIFields.username).errors | json }}\r\n    </clr-control-error>\r\n  </clr-input-container>\r\n\r\n  <clr-input-container>\r\n    <label>Password</label>\r\n    <input clrInput type=\"password\" [formControlName]=\"UIFields.password\" />\r\n    <clr-control-helper>Enter your password</clr-control-helper>\r\n    <clr-control-error>\r\n      {{ loginForm.get(UIFields.password).errors | json }}\r\n    </clr-control-error>\r\n  </clr-input-container>\r\n\r\n  <button class=\"btn btn-sm btn-primary\" type=\"submit\" (click)=\"submit()\">Login</button>\r\n</form>"
...
var LoginComponent = /** @class */ (function () {
    ...
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])(_clr_angular__WEBPACK_IMPORTED_MODULE_2__["ClrForm"]),
        __metadata("design:type", Object)
    ], LoginComponent.prototype, "clrForm", void 0);
    ...
    LoginModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            imports: [
                ...
                _clr_angular__WEBPACK_IMPORTED_MODULE_3__["ClrFormsDeprecatedModule"],
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _core_rest_manager_rest_manager__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../core/rest-manager/rest.manager */ "./src/app/core/rest-manager/rest.manager.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var LoginService = /** @class */ (function () {
    function LoginService(restManager) {
    ...
    LoginService = __decorate([
        ...
        __metadata("design:paramtypes", [_core_rest_manager_rest_manager__WEBPACK_IMPORTED_MODULE_1__["RestManager"]])
    ], LoginService);
    return LoginService;
}());
...
module.exports = "<h3>Register</h3>\r\n\r\n<form clrForm [formGroup]=\"registerForm\">\r\n  <clr-input-container>\r\n    <label>Username</label>\r\n    <input clrInput type=\"text\" [formControlName]=\"UIFields.username\" />\r\n    <clr-control-helper>Enter your username</clr-control-helper>\r\n    <clr-control-error>\r\n      {{ registerForm.get(UIFields.username).errors | json }}\r\n    </clr-control-error>\r\n  </clr-input-container>\r\n\r\n  <clr-input-container>\r\n    <label>Password</label>\r\n    <input clrInput type=\"password\" [formControlName]=\"UIFields.password\" />\r\n    <clr-control-helper>Enter your password</clr-control-helper>\r\n    <clr-control-error>\r\n      {{ registerForm.get(UIFields.password).errors | json }}\r\n    </clr-control-error>\r\n  </clr-input-container>\r\n\r\n  <button class=\"btn btn-sm btn-primary\" type=\"submit\" (click)=\"submit()\">Register</button>\r\n</form>"
...
var RegisterComponent = /** @class */ (function () {
    ...
    RegisterComponent.prototype.ngOnInit = function () {
        this.registerForm = this.fb.group((_a = {},
            _a[UIFields.username] = ['', [
    ...
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])(_clr_angular__WEBPACK_IMPORTED_MODULE_1__["ClrForm"]),
        __metadata("design:type", Object)
    ], RegisterComponent.prototype, "clrForm", void 0);
    ...
    RegisterModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            imports: [
                ...
                _clr_angular__WEBPACK_IMPORTED_MODULE_4__["ClrFormsDeprecatedModule"],
